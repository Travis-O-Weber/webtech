          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-nav-first">
                         ...
                         <li><a href="index.php?page=career" class="smoothScroll">Career</a></li>
                         <li><a href="index.php?page=contact" class="smoothScroll">Contact</a></li>
                         <li><a href="index.php?page=education" class="smoothScroll">Education</a></li>
                         <li><a href="index.php?page=gaming" class="smoothScroll">Gaming</a></li>
