                ...
                <div class="col-md-12">
					...
					echo "Form submitted.<br>";
						if ($isValid) {
							...
							VALUES ('$firstName', '$lastName', '$email', '$phoneNumber', '$username', '$password', '$comments')";


							// Attempt to execute the insertion
							if ($dblink->query($sql) == TRUE) {
								echo '<h2> Your data has been saved successfully.</h2>';
							} else {
								echo "<h2> Something went wrong with the insert: " . $dblink->error . '</h2>';
							}
